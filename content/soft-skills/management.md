...
- Проактивные действия и управление рисками
    - [ ] Запустить процесс без согласования с руковоством и оценить результат в конце недели
    - [ ] Выбрать риск и проработать варианты
    - [ ] Провести симуляцию ситуации в которой вся комнда недоступна
    - [ ] В конце квартала делится факапами и мерами по их недопущению
...
* Как работыть на идиота? Руководство по выживанию (Джон Гувер)