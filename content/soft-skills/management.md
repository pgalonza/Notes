...
- Проактивные действия и управление рисками
    ...
    - [ ] В конце квартала делиться неудачами и мерами по их недопущению
    - [ ] Выбрать любую задачу, которая откладывается, и решить её всей командой
...
SCRUM — фреймворк гибкой разработки, используемый для управления проектами.
...
Kanban — метод визуализации workflow, позволяющий оптимизировать процессы.
